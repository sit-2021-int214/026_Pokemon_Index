...
```
comproBook %>% ggplot(aes(x=Type)) + 
  geom_bar(aes(fill = Type)) + 
  ggtitle("Total of Types") + xlab("count") + ylab("Type of Books")
```
Result:

![Graph 1](https://github.com/sit-2021-int214/026_Pokemon_Index/blob/main/img/img_63130500116/barType_63130500116.png)
